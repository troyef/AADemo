...
React.createElement("div", null, 
      React.createElement("div", null, this.props.data.svc_description), 
...
var Concepts = React.createClass({displayName: "Concepts",
  ...
  render: function() {
    var conceptNodes = this.props.data.map(function(concept, index) {
        return (
          React.createElement("li", {key: index}, React.createElement("a", {href: concept.dbpedia, target: "_blank"}, concept.text), 
            React.createElement("span", {className: "relevance"}, concept.relevance)
          )
        );
      });
  ...
  render: function() {
    ...
    var keywordNodes = this.props.data.map(function(keyword, index) {
      if (keyword.text.toLowerCase() !== pageKeyword)
          return (
            React.createElement("li", {key: index}, keyword.text, 
              React.createElement("span", {className: "relevance"}, keyword.relevance), 
              React.createElement("span", {className: "sentiment"}, keyword.sentiment.type)
            )
          );
        });
...
var Sentiment = React.createClass({displayName: "Sentiment",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, "Sentiment: ", this.props.data.type, " ", mixed, " (", this.props.data.score, ")")
    );
  }
...
var Main = React.createClass({displayName: "Main",
  ...
  render: function render() {
    return (
React.createElement("div", null, 
      React.createElement("h1", null, "Keyword: ", this.state.keyword, 
      React.createElement("span", {className: "updatebtn", onClick: this.showUpdateKeywordClick}, "update")
      ), 
       this.state.showUpdateKeyword ? React.createElement(UpdateKeyword, {keyword: this.state.keyword, onUpdateKeyword: this.onUpdateKeyword}) : null, 
      
      
      React.createElement("h2", null, "Service: Stackoverflow"), 
      React.createElement(AnalysisBox, {data: this.state.stackexchange, keyword: this.state.keyword}), 
      React.createElement("h2", null, "Service: Twitter"), 
  ...
  render: function render(){
    return (
      React.createElement("div", null, 
        ...
        React.createElement("button", {onClick: this.onClick}, "Update Keyword")
      )
    );
  }
});
