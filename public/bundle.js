...
var AnalysisBox = React.createClass({displayName: "AnalysisBox",
  ...
  render: function() {
    ...
    if (!this.props.data.hasOwnProperty('svc_description'))
      return (
          React.createElement("div", {style: this.styles.analysisBox}, 
    ...
    return (
React.createElement("div", {style: this.styles.analysisBox}, 
      React.createElement("div", {style: this.styles.serviceTitle}, this.props.data.svc_title), 
      React.createElement("div", {style: this.styles.serviceDesc}, this.props.data.svc_description), 
  
      React.createElement(Sentiment, {data: keywordSentiment}), 
      React.createElement(Keywords, {data: this.props.data.keywords, keyword: this.props.keyword}), 
      React.createElement(Concepts, {data: this.props.data.concepts})
...
},{"./concepts":2,"./keywords":3,"./sentiment":4,"react":164}],2:[function(require,module,exports){
var React = require('react');

var Concepts = React.createClass({displayName: "Concepts",
    ...
    var conceptNodes = this.props.data.map(function(concept, index){
      if (this.state.maxRecords === -1 || index <= this.state.maxRecords){
          ...
          React.createElement("li", {key: index}, 
            React.createElement("a", {style: this.styles.concept, href: concept.dbpedia, target: "_blank"}, concept.text), 
            React.createElement("span", {style: this.styles.score}, "Relevance: ", concept.relevance)
          )
          );
        }
      }.bind(this));
    return (
      React.createElement("div", {style: this.styles.sectionDiv}, 
        React.createElement("div", {style: this.styles.sectionTitle}, "Associated Concepts"), 
        React.createElement("ol", {style: this.styles.list}, 
          conceptNodes
        ), 
        hasMoreData === true ? 
          React.createElement("div", {style: this.styles.quantityBtn, onClick: this.clickQuantBtn}, this.state.maxRecords !== this.defaultRecordCount ? 'show fewer' : 'show more')
          : null
  ...
  render: function() {
    ...
    var keywordNodes = this.props.data.map(function(keyword, index) {
      if (keyword.text.toLowerCase() !== pageKeyword && (this.state.maxRecords === -1 || index <= this.state.maxRecords))
          return (
            React.createElement("li", {key: index}, 
              React.createElement("span", {style: this.styles.keyword}, keyword.text), 
              React.createElement("span", {style: this.styles.score}, "Relevance: ", keyword.relevance), 
              React.createElement("span", {style: this.styles.sentiment}, "Sentiment: ", keyword.sentiment.type)
            )
          );
        }.bind(this));
    ...
    return (
      React.createElement("div", {style: this.styles.sectionDiv}, 
        React.createElement("div", {style: this.styles.sectionTitle}, "Associated Keywords"), 
        React.createElement("ol", {style: this.styles.list}, 
          keywordNodes
        ), 
        React.createElement("div", {style: this.styles.quantityBtn, onClick: this.clickQuantBtn}, this.state.maxRecords !== this.defaultRecordCount ? 'show fewer' : 'show more')
...
var Sentiment = React.createClass({displayName: "Sentiment",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {style: this.styles.sentimentBox}, 
      
      this.props.data.hasOwnProperty('type') === true ? 
          React.createElement("span", null, "Overall User Sentiment: ", React.createElement("span", {style: this.styles.sentiment}, sentimentVal), " ", React.createElement("span", {style: this.styles.score}, "(", this.props.data.score, ")"))
          : React.createElement("span", null, "No keyword matches returned for sentiment.")
...
},{"./main":7,"react":164}],7:[function(require,module,exports){
var React = require('react');
...
var Main = React.createClass({displayName: "Main",
  ...
  render: function render() {
    return (
React.createElement("div", {style: this.styles.mainContent}, 
      React.createElement("div", {style: this.styles.demoTitle}, "AlchemyAPI Keyword Analysis"), 
      React.createElement("div", {style: this.styles.keywordDiv}, "Keyword: ", React.createElement("span", {style: this.styles.keyword}, this.state.keyword, " "), 
         this.state.showUpdateKeyword ? React.createElement(UpdateKeyword, {keyword: this.state.keyword, onUpdateKeyword: this.onUpdateKeyword, onCancel: this.showUpdateKeywordClick}) 
            : React.createElement("span", {style: this.styles.updatebtn, onClick: this.showUpdateKeywordClick}, "update")
      ), 
      
      
      
      React.createElement(AnalysisBox, {data: this.state.stackexchange, keyword: this.state.keyword}), 
      React.createElement(AnalysisBox, {data: this.state.twitter, keyword: this.state.keyword})
...
var UpdateKeyword = React.createClass({displayName: "UpdateKeyword",
  ...
  render: function render(){
    return (
      React.createElement("div", null, 
        React.createElement("input", {type: "text", ref: "keyword", defaultValue: this.props.keyword}), 
        React.createElement("button", {style: this.styles.updateBtn, onClick: this.onClick}, "Update Keyword"), 
        React.createElement("span", {style: this.styles.cancelbtn, onClick: this.onCancel}, "cancel")
      )
    );
  },
...
},{"./analysisBox/analysisBox":1,"./apiService":5,"react":164}],8:[function(require,module,exports){
